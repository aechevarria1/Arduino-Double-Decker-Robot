/*
 * Debug script for code that will go on the robot. Debugging for 1.00 build
*/
...
//Servos are attached to 9 and 11
...
void do_command(){
  Serial.println(servo_speed_f);
  Serial.println(servo_speed_b);
  switch (command){
    case Up:
      servoR.write(servo_speed_b);
      servoL.write(servo_speed_f);
